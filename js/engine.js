    ...
    var firstitem = []
        ...
        victimsarray.forEach(function (victimsarrayitem) {
            if (victimsarrayitem == "Unknown"){
                ...
                ul.append(rivalname)
                rivalname.innerHTML += ('<div class="row"><div class="col-md-3 col-4">Name</div><div class="col-md-9 col-8">'+ victimsarrayitem.name +'</div></div>');
                ul.append(rivalgrade)
                rivalgrade.innerHTML += ('<div class="row"><div class="col-md-3 col-4">Grade</div><div class="col-md-9 col-8">'+ victimsarrayitem.grade +'</div></div>');
                ul.append(rivalstatus)
                rivalstatus.innerHTML += ('<div class="row"><div class="col-md-3 col-4">Status</div><div class="col-md-9 col-8">'+ victimsarrayitem.status +'</div></div>');
            }
        });
