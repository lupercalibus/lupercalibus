        ...
        beforeDraw: function(chart) {
            ...
            if (chart.config.options.elements.imgcenter) {
               ...
               // var elementHeight = (chart.innerRadius * 2);
                ...
                //Set font settings to draw it correctly.
                var centerX = ((chart.chartArea.left + chart.chartArea.right) / 2) - chart.innerRadius + (sidePaddingCalculated/2);
                var centerY = ((chart.chartArea.top + chart.chartArea.bottom) / 2) - chart.innerRadius + (sidePaddingCalculated/2);
