    ...
    var firstitem = []
        ...
        dati.forEach(function(arrayItem) {
            ...
            if (arrayItem["number"] == 1) {
                firstitem = arrayItem
                datesfirst.push({id: arrayItem["number"], title: (arrayItem["place"]) +" "+ Date(arrayItem["date"]).toDateString(), start: arrayItem["date"], className: "dogfight"})
                ...
                datesarray.push({id: arrayItem["number"], title: (arrayItem["place"]) +" "+ Date(arrayItem["date"]).toDateString(), start: arrayItem["date"], className: "dogfight"})
