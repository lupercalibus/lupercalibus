    ...
    var firstitem = []
        ...
        victimsarray.forEach(function (victimsarrayitem) {
            if (victimsarrayitem == "Unknown"){
                ...
                ul.append(rivalname)
                rivalname.innerHTML += ('<div class="row"><div class="col-md-3 col-5">Name</div><div class="col-md-9 col-5">'+ victimsarrayitem.name +'</div></div>');
                ul.append(rivalgrade)
                rivalgrade.innerHTML += ('<div class="row"><div class="col-md-3 col-5">Grade</div><div class="col-md-9 col-5">'+ victimsarrayitem.grade +'</div></div>');
                ul.append(rivalstatus)
                rivalstatus.innerHTML += ('<div class="row"><div class="col-md-3 col-5">Status</div><div class="col-md-9 col-5">'+ victimsarrayitem.status +'</div></div>');
            }
        });
