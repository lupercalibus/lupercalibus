...
legend.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend');
     div.innerHTML =
            '<ul><li><h1 style="color: #FF0000">-</h1> Border</li> <li><h1 style="color: blue">-</h1> Flight</li> <li><img src="css/base.png" height="30"> Base</li> <li><img src="css/dogfight.png" height="30"> Dogfight</li></ul> ';
    return div;
};
