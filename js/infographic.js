    ...
    news13 = [engine[3], speed[3], weight[3], len[3], span[3]]
        ...
        $('input[type=radio][name=planes]').change(function() {
            switch ($(this).val()) {
              ...
              //Wordcloud
              var words = [
                {text: "nemico", weight:47},
                {text: "apparecchio", weight:36},
                {text: "fuoco", weight:23},
                {text: "caccia", weight:22},
                {text: "ala", weight:20},
                {text: "quota", weight:19},
                {text: "colpo", weight:18},
                {text: "linea", weight:18},
                {text: "terra", weight:16},
                {text: "attacco", weight:16},
                {text: "fiamma", weight:16},
                {text: "albatros", weight:15},
                {text: "colpito", weight:14},
                {text: "mitragliatrice", weight:14},
                {text: "distanza", weight:14},
                {text: "caduta", weight:11},
                {text: "pilota", weight:10},
                {text: "osservatore", weight:10},
                {text: "velivolo", weight:9},
                {text: "palla", weight:8},
                {text: "direzione", weight:7},
                {text: "monte", weight:7},
                {text: "Piave", weight:7}
            ];
